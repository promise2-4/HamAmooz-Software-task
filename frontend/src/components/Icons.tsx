...
export const ClusterIcon = (props: IconProps) => (
  <IconBase {...props}>
...
export const EditIcon = (props: IconProps) => (
  <IconBase {...props}>
    <path d="m4 20 4.2-1 10.7-10.7a2.1 2.1 0 0 0-3-3L5.2 16 4 20ZM14.5 6.5l3 3" />
  </IconBase>
);
...
export const AlertIcon = (props: IconProps) => (
  <IconBase {...props}>
    ...
    <path d="M10.3 3.8 2.8 17a2 2 0 0 0 1.8 3h14.8a2 2 0 0 0 1.8-3L13.7 3.8a2 2 0 0 0-3.4 0Z" />
  </IconBase>
);
