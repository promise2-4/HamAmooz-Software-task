    ...
    <main className="login-page">
      ...
      <section className="login-panel">
        ...
        <div className="login-copy">
          ...
          <h1>A clear view of every workload.</h1>
          <p>
            Manage Kubernetes namespaces and applications from one focused
            workspace.
          </p>
        </div>
      ...
      <section className="login-form-wrap">
        <form className="login-form" onSubmit={submit}>
          ...
          <p>Use your Hemmasian account credentials.</p>
          ...
          <p className="auth-switch">
            New to Hemmasian? <Link to="/signup">Create an account</Link>
          </p>
          <small className="security-note">
            Credentials are kept only for this browser session.
          </small>
        </form>
      </section>
    </main>
